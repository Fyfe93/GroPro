...
Window {
    ...
    Slider {
        ...
        onValueChanged: {
            ...
            groProController.sendMessage(value, sliderIndicator)
        }
    ...
    Slider {
        ...
        property int sliderIndicator: 3
    ...
    Button {
        ...
        onClicked: {
            ...
            groProController.sendMessage("0","7")
    ...
    Button {
        ...
        onClicked: {
            groProController.sendMessage("0","8")
    ...
    Button {
        ...
        wheelEnabled: false
        highlighted: false
        property int warmButtonIndicator: 4

        onClicked: {
            groProController.sendMessage("0", warmButtonIndicator)
        }
    }
    ...
    Button {
        ...
        property int coldButtonIndicator: 5

        onClicked: {
            groProController.sendMessage("0", coldButtonIndicator)
        }
    }
    ...
    Button {
        ...
        property int whiteButtonIndicator: 6

        onClicked: {
            groProController.sendMessage("0", whiteButtonIndicator)
        }
    }
