![alt text](https://github.com/Fyfe93/GroPro/blob/master/GroProLogo.png)
...
Regular updates and promotions can be found on our social media pages. [![alt text](https://github.com/Fyfe93/GroPro/blob/master/Icons/instagram_icon.png)](https://www.instagram.com/groproglasgow/) [![alt text](https://github.com/Fyfe93/GroPro/blob/master/Icons/twitter_icon.png)](https://twitter.com/GroProGlasgow) and [![alt text](https://github.com/Fyfe93/GroPro/blob/master/Icons/YouTube.png)](https://www.youtube.com/channel/UC6INIFKsnIOoyIMZFyKa2zQ). You can also follow the project's progress, interact with the developers and put forward your ideas for improvements through the above links.
